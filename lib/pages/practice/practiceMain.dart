...
class _PracticePageState extends State<PracticePage> {
  ...
  void _navigateToPracticeDecimalToBinary(BuildContext context) {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () => _navigateToPracticeBinaryToDecimal(
                        context,
                      ), // Setup Nav here
                      child: const Text(
                        'Binary to Numbers',
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () => _navigateToPracticeBinaryToText(
                        context,
                      ), // Setup Nav here
                      child: const Text(
                        'Binary to Text',
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () => _navigateToPracticeDecimalToBinary(
                        context,
                      ), // Setup Nav here
                      child: const Text(
                        'Decimal to Binary',
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () => _navigateToPracticeTextToBinary(
                        context,
                      ), // Setup Nav here
                      child: const Text(
                        'Text to Binary',
